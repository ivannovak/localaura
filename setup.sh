...
echo ""
echo "3. Add your services using Docker labels (see docker-compose.example.yml)"
echo "   OR add non-Docker sites:"
echo "   ./add-site.sh myapp.aura http://localhost:3000"
echo ""
echo "Available commands:"
echo "  ./add-site.sh <domain> [target]  - Add a new site"
echo "  ./remove-site.sh <domain>        - Remove a site"
echo "  ./list-sites.sh                  - List all sites"
echo ""
echo "The proxy will run on 127.0.0.2 to avoid conflicts with"
